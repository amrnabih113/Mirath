...
class InitiateFullAccountDataExportUsecase extends UseCase<String, NoParams> {
  final SettingsRepository repository;
  InitiateFullAccountDataExportUsecase(this.repository);
  @override
  Future<Either<Failure, String>> call(NoParams params) async {
    return await repository.initiateFullAccountDataExport();
  }
}
