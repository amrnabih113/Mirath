            ...
            children: [
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        FeedTiles(
                          ...
                          subtitle:
                              'When off, only people you follow can comment',
                          trailing: Switch(
                        ...
                        FeedTiles(
                          ...
                          trailing: Switch(
                            value:
                                preference.useReadingBehaviorForRecommendations,
                            onChanged: (value) {
                              final updatedPreference = preference.copyWith(
              ...
              AccountTiles(
                ...
                onTap: () {
                  ...
                  context.read<SettingsCubit>().initiateFullAccountDataExport();
                },
              ),
    ...
    return Column(
      ...
      children: [
          ...
          onTap: () {
            showButtonDialog(
              ...
              tilesName: ExportListFormate.values
                  ...
                  .toList(),
              onselect: (index) {
                final selectedFormate = ExportListFormate.values[index];
        ...
        AccountTiles(
          ...
          subtitle: 'Download all highlights and notes as Markdown or JSON',
          btnName: 'Export',
          onTap: () {
            showButtonDialog(
              context,
              ...
              tilesName: ExportAnnotationsFormate.values
                  ...
                  .toList(),
              onselect: (index) {
                final selectedFormate = ExportAnnotationsFormate.values[index];
                context.read<SettingsCubit>().exportAnnotationsAndNotes(
                  formate: selectedFormate,
                );
                context.push(RouteNames.verifyIdentity);
              },
