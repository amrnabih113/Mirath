...
class PageTransitions {
  ...
  /// Legacy Route-based methods for backward compatibility with Navigator
  /// Use Page-based methods above for GoRouter

  /// Fade transition (Route-based)
  static Route fadeTransitionRoute(Widget page) {
  ...
  /// Slide from right transition (Route-based)
  ...
  /// Smooth transition (Route-based)
  static Route smoothTransitionRoute(Widget page) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => page,
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        const begin = Offset(0.03, 0.0);
